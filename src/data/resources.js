...
export const RESOURCES = [
	...
	{ id: 'wikipedia_source', name: 'Wikipedia (source)', icon: '📖', description: 'Wikipedia in the source language', url_template: 'https://{sl}.wikipedia.org/w/index.php?search={query}', lang_format: 'iso2', bidirectional: true, inline: { kind: 'mediawiki', host: 'wikipedia', side: 'source' } },
	{ id: 'wikipedia_target', name: 'Wikipedia (target)', icon: '📖', description: 'Wikipedia in the target language', url_template: 'https://{tl}.wikipedia.org/w/index.php?search={query}', lang_format: 'iso2', bidirectional: true, inline: { kind: 'mediawiki', host: 'wikipedia', side: 'target' } },
	{ id: 'wiktionary_source', name: 'Wiktionary (source)', icon: '📓', description: 'Wiktionary in the source language', url_template: 'https://{sl}.wiktionary.org/wiki/{query}', lang_format: 'iso2', bidirectional: true, inline: { kind: 'mediawiki', host: 'wiktionary', side: 'source' } },
	{ id: 'wiktionary_target', name: 'Wiktionary (target)', icon: '📓', description: 'Wiktionary in the target language', url_template: 'https://{tl}.wiktionary.org/wiki/{query}', lang_format: 'iso2', bidirectional: true, inline: { kind: 'mediawiki', host: 'wiktionary', side: 'target' } },

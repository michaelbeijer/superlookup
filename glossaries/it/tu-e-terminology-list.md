...
| Technische Innovatiewetenschappen | Innovation Sciences |  |
| Technische Bedrijfskunde | Industrial Engineering and Management Sciences |  |
| Technische Wiskunde | Applied Mathematics |  |
| Technische Informatica | Computer Science & Engineering |  |
| Werktuigbouwkunde | Mechanical Engineering |  |
| Electrical Engineering | Electrical Engineering |  |
| Technische Natuurkunde | Applied Physics |  |
| Scheikundige Technologie | Chemical Engineering |  |
| Bouwkunde | Architecture, Urbanism and Building Sciences |  |
...
| Dienst Financiёle en Economische Zaken | Finance and Control (F&C) |  |
| Dienst Huisvesting (DH) | Real Estate (RE) |  |
| Dienst Informatie en Communicatie Technologie (DICT) naam is verouderd Dienst Information Management & | Information and Communication Technology Service (DICT) name now defunct |  |
...
| Centrale Commissie Kwaliteitszorg | Central Committee for Quality Care in Education |  |
...
| Adviescommissie Examens Mastersopleidingen | Advisory Committee on Master’s Programs Examinations |  |
...
| afstudeerdocent | thesis supervisor |  |
...
| Bestuurlijk Overleg (BO) | University Consultative Council (BO) |  |
...
| CROHO (Centraal Register Opleidingen Hoger | Central Register of Higher Education Degree Programs (Central |  |
...
| functioneringsgesprek (verouderde term, nu | (annual) job performance interview |  |
...
| inschrijving (als student aan TU/e of aan een | enrollment (at TU/e or in a TU/e program) |  |
...
| inschrijving intrekken (intrekken van | to withdraw a request for enrollment |  |
...
| Minister van Onderwijs, Cultuur en | Minister of Education, Culture and Science |  |
| Ministerie van Onderwijs, Cultuur en | Ministry of Education, Culture and Science (OC&W) |  |
...
| Notebookregeling (TU/e) Participatie- | Notebook Plan (TU/e) contract |  |
| numerus fixus | intake restriction |  |
...
| onderwijs | education / courses / field of education / teaching / instruction |  |
| onderwijsadministratie (verouderde term | Center for Student Administration |  |
...
| (gemeenschappelijke) opleidingscommissie | (joint) program committee (J)(PC) |  |
| opleidingsdirecteur | Program Director |  |
...
| Stichting Fundamenteel Onderzoek der Materie | The Foundation for Fundamental Research on Matter |  |
| Stichting voor de Technische Wetenschappen (STW) | Technology Foundation (STW) |  |
| studeerbaar | manageable (studiable and studiability are only used rarely) |  |
...
| studie | study program (informal) / degree program (formal) / studies Which degree program are you enrolled in? |  |
...
| studielast studieloopbaanadviseur | study load |  |
...
| switcher (iemand die in het studiejaar voorafgaand aan het studiejaar waarvoor hij zich aanmeldt een inschrijving heeft aan de TU/e (interne switcher) dan wel elders bij een instelling voor hoger of wetenschappelijk onderwijs | (internal) transfer student / (external) transfer student |  |
...
| toelatingsbewijs | proof of admission |  |
...
| vakgroep (verouderde term vervangen door | group |  |
...
| versterking bestuurskracht van | governance reinforcement for educational institutions |  |
...
| Wet op het Hoger Onderwijs en | Higher Education and Scientific Research Act (WHW) |  |

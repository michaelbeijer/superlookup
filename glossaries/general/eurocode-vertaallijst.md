...
| 9.05 | and suchlike,, en dergelijke, wordt niet afgekort! |  |
| 8.151 | Annex, bijlage |  |
...
| 9.15 | hazard, danger potentiel, aléa, gefährdung, bedreiging,, GOV: gevaarlijk ongewoon voorval |  |
...
| 8.15 | National Annex (NA), annexe nationale (AN), nationale bijlage [in het algemeen, ongeacht het land], [B]: ANB, ANB (voor België) en NB (voor Nederland) worden enkel op nationaal vlak gebruikt, niet in een EN |  |
...
| 20.01 | aggregate, granulat, toeslagmateriaal [standaard in NL],, NL: aggregaat, zie ook 90.08 |  |
...
| 30.56 | distorsional deformation, déformation de distorsion, Querschnittsverformung, vervorming van de dwarsdoorsnede door niet-vormvastheid,, doorgeven aan NL-expert; is besproken met Nl expert en acc. |  |
...
| 40.124 | density, volumieke massa,, afhankelijk van de eenheden, echter zonder nadere aanduiding meestal volumiek gewicht. |  |
...
| 90.08 | aggregate, granulat, toeslagmateriaal [standaard in NL],, NL: aggregaat, zie ook 20.01 |  |
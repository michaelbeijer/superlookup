...
| billion | in V.K. biljoen (10<sup>12</sup>), |  |
...
| minuend | aftrekgetal |  |
| milliard | miljard (10<sup>9</sup>) (in V.S. ’billion’ |  |
| million | miljoen (10<sup>6</sup>) |  |
| model | model |  |
...
| outer product | produktmatrix uv<sup>T</sup> |  |
...
| pure | zuiver |  |
| pyramid | piramide |  |
| QR factorization | QR-ontbinding |  |
| quadrangle | vierhoek |  |
| quadruple | viertal, viervoud, viervoudig |  |
| quadratic | kwadratisch |  |
| quadratic equation | vierkantsvergelijking |  |
| quadratic form | kwadratische vorm |  |
| quadrature | kwadratuur |  |
| quantity | grootheid |  |
| quintuple | vijftal, vijfvoud, vijfvoudig |  |
| Radical | wortel |  |
| radicand | grondtal (v.e. wortel) |  |
| radius (mv. radii) | straal |  |
| radius of curvature | kromtestraal |  |
| radix | grondtal, basis; wortel |  |
| random | aselect |  |
| random variable | stochastische variabele |  |
| range | bereik |  |
| rank | rang |  |
| rate | mate, hoeveelheid |  |
| ratio | verhouding |  |
| real | reëel (getal) |  |
| reciprocal | duaal; invers(e); omgekeerd(e); |  |
| rectangle | rechthoek |  |
| rectilinear | rechtlijnig |  |
| recurrence relation | recurrente betrekking |  |
| recursive | recursief |  |
| reduce | vereenvoudigen, reduceren |  |
| reduced echelon form | rijkanonieke vorm |  |
...
| virtual | virtueel |  |
| void | leeg |  |
| Zero | nul, nulpunt nulmatrix nuloplossing nulruimte, {0} zeer veel |  |
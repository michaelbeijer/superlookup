...
| - met  grote overspanning | wide-span beam |  |
| - op 3  steunpunten | beam of two spans |  |
...
| - (theater) | dress circle, mezzanine |  |
...
| - (met bakst) | brick |  |
| - (metplaatmat.) | clad, sheath |  |
| - (met slof) | cloth covering |  |
...
| - met  kilgoot | valley roof |  |
| - met  spanten | framed roof |  |
| - met  vlakke pannen | plain-tile roof |  |
| - met  wolfseinden | gambrel ~Z half-hipped roof |  |
...
| - met  messing en groef | close boarding, matched roof boards |  |
| -zonder * | open boarding |  |
| dakdekken | roof |  |
| ~ (mol leien) | slate |  |
| - (mol pannen) | tile |  |
| - (met riet) | reed, thatch |  |
...
| - met  schilddak | hipped dormer roof |  |
| - met  zadeldak | gable dormer roof |  |
| - met  lessenaarsdak | shed roof dormer |  |
| dakkoepel | roof dome |  |
...
| - over de  topgevel | rake, raking cope |  |
| zonder - | flush eaves |  |
| - zonder  goot | dripping eaves |  |
| dakpan | (roof) tile |  |
...
| - (akoest.) | attenuate, deaden, muffle |  |
| ~ (grondw.) | fill in, fill up, earth up |  |
| - (verlichting) | dim, subdue |  |
| detail | detail |  |
| - op ware  grootte | epure |  |
| detailleren | detail |  |
| deuk | dint |  |
| deur | door |  |
...
| - (naden) | seal, proof, cover |  |
| - (vullen voegen/naden) | caulk, calk, seal |  |
| dichtheid | density |  |
...
| -  dooreigengewicht | natural sagging |  |
...
| draad | wire |  |
| - (houtvezel) | ligneous fibre |  |
| - (melseldraad) | mason’s line |  |
| - (schroefdraad) | screw-thread |  |
| - (tapse schroefdraad) | tapered thread |  |
...
| - (gebouw) | low-rise, one-storey, one-storied |  |
...
| - op palen | pile foundation |  |
| ~ op  pijlers | pier foundation |  |
| - op  plaatvloer | raft -/ slab foundation |  |
...
| gebint <het> | couple truss, coupled rafters |  |
...
| - aan  achterzijde | backfa^ade, back front |  |
...
| - (tussen ramen) | spandrel, apron wall |  |
...
| - v/e  sporenkap | rafter-supporting purlin |  |
...
| - (amerikaans) | pitch pine, yellow pine |  |
...
| - boven  maaiveld | level above grade |  |
...
| - balk | balk, baulk, timber beam |  |
| -dekvloer | block flooring |  |
| -klos | bearing block, angle cleat |  |
| - kolom | timber stanchion |  |
| - plint | skirt board, baseboard |  |
| ~  regelwerk | common grounds, rough ground |  |
| - schot | batten wall, board partition,  timber-lined shed |  |
| -  vloerconstructie | timber joist floor |  |
| - vlonder | boardwalk, duckboard, strake |  |
...
| - (vocht in constr.) | seep in, infiltrate, trickle in |  |
...
| l-profiel | 1-section |  |
| isolatie | insulation |  |
| - (van buizen) | pipe lagging/- insulation |  |
...
| - (betonsteen) | clinker block, cement clinker |  |
| - (bestrating) | paving brick, paver, double format |  |
| klinknagel | rivet |  |
...
| - (in een dak) | roof curb |  |
| - (statica) | (dynamic) buckling |  |
...
| - (paddestoelvloer) | flared column head |  |
...
| - (stelpost) | cash allowance, contigency sum |  |
...
| - (gasleiding) | gas cock, gas tap |  |
| - (waterleiding) | faucet, tap |  |
...
| - (parketvloer) | slat, strip, wood laminate |  |
...
| - (houtconstr.) | halved -/ tabled ~/ hal-lap joint, scarf |  |
| - (staalconstr.) | abutting joint, weld, weldment |  |
...
| - (elek. bedrading) | wire, cable, line, wiring |  |
| ~ (elek. aansluiting) | in-lead, lead |  |
| - (water/gas binnen) | conduit |  |
| - (sanitair) | Pipe |  |
...
| gepleisterd <sup>54</sup> | rendered brickwork |  |
...
| - in  muurverband | ashlar, squared stone |  |
...
| - (water) | level, table, water surface |  |
| - (akoust.) | sound pressure level |  |
...
| ~  stootvoeg | weephole |  |
| - voeg | drained -/ open -/ hollow joint |  |
...
| - (kubus) | arris, edge |  |
| - (houtconstr.) | baulk, scantling, squared log |  |
...
| rioollucht | foul air |  |
| roede | rod |  |
| - (glas) | muntin, sash bar, spoke, glass bar |  |
...
| schroef | screw |  |
| - met  platverz. kop | countersunk screw |  |
| - met  ronde kop | button-head -1  dome-headed screw |  |
...
| veld | field |  |
| - (gewelf) | vault bay, severy |  |
| - (vloer) | slab span, bay, trave |  |
...
| - van trap | rise and run ratio |  |
| - hoogte-overspanning | depth-span ratio |  |

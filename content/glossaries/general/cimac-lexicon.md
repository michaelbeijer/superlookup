...
| aanslag | stop block; catch |  |
| aanzethandel | starting lever; starting handle |  |
| aanzetklep | starting valve |  |
| aanzetlucht; startlucht | starting air |  |
| aanzetluchtvat; aanzetluchtreservoir | starting air receiver; starting air vessel; starting air bottle |  |
| aanzetluchtvat | starting air bottle (en-GB); starting air tank (en-US) |  |
| aanzetslinger | starting crank |  |
| aanzetten met druklucht | compressed air starting |  |
| aanzetten; starten | to start |  |
| aanzuig opening; inlaatopening | suction opening |  |
| aanzuigleiding | induction manifold |  |
| aanzuigslag | intake stroke |  |
| accu; batterij | accumulator; storage battery |  |
| accu; batterij | storage batteries |  |
| achteruit rondsel | reverse gear wheel |  |
| afblaaskraan; ontlastkraan | delivery cock; blow off cock |  |
| afsluiter; stopkraan | stop valve; cut off valve |  |
| afstand bediening | remote control |  |
| afvoerleiding | discharge pipe |  |
| afvoeropening | discharge nozzle; exhaust nozzle |  |
| as | shaft |  |
| asflens | half coupling; shaft flange |  |
| ashals; pen | pin; gudgeon pin |  |
| atmosferische aanzuiging | natural aspiration; normal aspiration |  |
...
| buitenlucht | free air; ambient air |  |
| carburator | carburettor |  |
| cardankoppeling; kruiskoppeling | universal joint |  |
| carter | casing |  |
...
| cilindermantel | cylinder jacket; water jacket |  |
...
| compressorwaaier | compressor impeller; compressor wheel (en-US) |  |
...
| derating; vermogens-vermindering | derating |  |
| dichtingsring | seal; scaling ring |  |
| Dieselmotor | Diesel engine |  |
| Dieselmotor; compressie-ontstekingsmotor | compression ignition engine |  |
| diffusor | diffuser |  |
| direct gekoppelde motor | direct drive engine; direct coupled engine |  |
| direct omkeerbaar | direct reversing |  |
| directe inspuiting | direct injection |  |
| distributiekast of nokaskast | timing gear casing; camshaft casing |  |
| distributieketting | timing chain |  |
| distributierondsel | timing sprocket; timing gear wheel |  |
| dompelpijp | dipping tube |  |
| dop; stop; plug | cap; plug |  |
...
| drijfwerk | piston and connecting rod assembly; running gear |  |
| drijvende riemschijf | driving pulley |  |
| droge voering | dry liner |  |
| drukgevuld | supercharged |  |
| druklagerkraag; stuwblok-kraag | thrust bearing collar |  |
...
| explosiemotor; motor met vonkontsteking | spark ignition engine |  |
| filterpatroon; filterelement | fitter cartridge |  |
| fixeerring (van kogellager) | retaining ring |  |
| flens | flange |  |
| frame; krukkast | frame |  |
| framevoet | foot of frame |  |
| fundatie | bed; foundation |  |
| fundatiebout | foundation bolt; holding down bolt |  |
| gasdruk | gas pressure |  |
| gashandel | gas lever |  |
| gasleiding | gas pipe |  |
| gasmotor | gas engine |  |
| geindiceerd vermogen | indicated power |  |
| geindiceerde gemiddelde druk | mean indicated pressure |  |
| gekoelde zuiger | cooled piston |  |
| gelast frame | welded frame |  |
| geluiddemper | silencer |  |
| gemiddelde zuigersnelheid | mean piston speed |  |
| generator set | electric power generating set |  |
| gespecificeerd vermogen; contractvermogen | specified power |  |
...
| gloeiplug; gloeibougie | glow plug; heater plug |  |
| grondplaat; fundatieplaat | base plate; bedplate |  |
| grote drijfstangkop of drijfstangvoet | connecting rod big end |  |
| handaanzetinrichting | hand starting device |  |
| handwiel | hand wheel |  |
| helling (van nok) | slope; profile; incline (of a cam) |  |
| het aanzetten; de start | start |  |
...
| hulpas | secondary shaft; lay shaft |  |
| hulpklep | auxiliary valve |  |
| hulp-luchtklep | auxiliary air valve |  |
| hulpmotor | auxiliary engine |  |
| hulpsproeier; compensatiesproeier | compensating jet |  |
| hydraulische koppeling | hydraulic clutch; hydraulic coupling |  |
| inblaaslucht; verstuivingslucht | injection air; blast air |  |
| indicateurkraan | indicator cock |  |
| industrie motor | industrial engine |  |
| injectie van (secundaire) lucht; luchtinspuiting | air injection |  |
| inlaat | inlet |  |
...
| inspectiedeksel | inspection door; inspection cover |  |
...
| kap | bonnet (en-GB); cover hood (en-US) |  |
| kap | cap |  |
| klauw koppeling | dog clutch |  |
| klauwen | claws; clamps |  |
| kleine drijfstangkop | small end connecting rod |  |
| klep | valve |  |
| klep schuren | to grind a valve |  |
| klepbeweging; klepmeehanisme | valve timing |  |
| klephefboom; tuimelaar | rocker arm |  |
| klephefboom; tuimelaar | valve rocker |  |
...
| kloppen | to knock |  |
| klopvast | antiknock |  |
| knalpot; geluiddemper | silencer (en-GB); muffler (en-US) |  |
| koeler | cooler |  |
...
| kolommen; frame; trekanke | columns; frame; tiebolts |  |
| koolafzetting; koolaanslag | carbon deposit |  |
...
| kruishoofdslof; leislof | crosshead slipper |  |
| kruiskop | crosshead |  |
...
| lagerschaal | bearing bush; bearing shell |  |
| langsspoeling; gelijkstroomspoeling | uniflow scavenging |  |
| leegloop; nullast | idling |  |
| leibaan | crosshead rail |  |
| leibaan | slide rail; guide rail |  |
| leidplaat | guide; deflector (for flow of fluid) |  |
...
| luchtinstallatie (druk-) | pneumatic plant; compressed air plant |  |
| luchtkamer | air cell |  |
| luchtklep | air valve; disc air valve |  |
| luchtkoeler | intercooler |  |
| luchtkoeling | air cooling |  |
| luchtleidingen | air piping |  |
| luchtlek | air leak |  |
| luchtovermaat; luchtoverschot | excess of air |  |
| luchtpomp | air pump |  |
| luchtstroom | air stream |  |
| luchtverhitter | air heater |  |
| luchtvulling | air charge |  |
| magneet | magneto |  |
| magnetische koppeling | magnetic clutch; magnetic coupling |  |
| mechanische inspuiting | mechanical injection; solid injection |  |
...
| mof; sok | sleeve |  |
| motor met cilinders radiaal opgesteld; stermotor | radial engine |  |
...
| motor met tegenover elkaar geplaatste cilinders (boxermotor) | opposed-cylinder engine; vis a vis engine |  |
| motor met tegenovergesteld werkende zuigers | opposed piston engine |  |
| motorblok | engine block |  |
| motorcompressor-aggregaat | motor driven compressor set; engine driven compressor set |  |
| motorframe | engine frame |  |
| motorpomp-aggregaat | motor driven pump set; engine driven pump set |  |
...
| nok | cam |  |
| nokas rondsel | camshaft sprocket; camshaft gear wheel |  |
| nokkenas | camshaft |  |
...
| omkeerspoeling; lusspoelin; dwarsspoeling | loop scavenging |  |
| omkeren van draairichting | change of direction of rotation |  |
| onderbroken bedrijf | intermittent rating |  |
| ondercarter | crankcase bottom half; casing lower part |  |
| onderdruk-regulateur | air suction governor; pneumatic governor |  |
| onderste cilindervoeringafdichting | cylinder liner lower joint; cylinder liner bottom joint |  |
| onderste dode punt (odp) | bottom dead centre; B.D.C. |  |
| ongekoelde zuiger | uncooled piston |  |
| onstekingsvolgorde | firing order |  |
| ontlastklep | relief valve |  |
| ontlastleiding; ontlastpijp; uitlaatpijp | exhaust pipe; discharge pipe; relief pipe |  |
| ontluchtingskraan; luchtveiligheidsklep | air separator pet cock; air blow off cock |  |
| ontluchtingspijp; afvoerpijp | drain pipe |  |
| ontluchtingsstop | air vent plug |  |
| ontsteking door cornpressie; compressie-ontsteking | compression ignition |  |
| ontstekingscircuit | ignition circuit |  |
| ontstekingstijdstip | ignition point |  |
| ontstekingsvertraging | ignition retard; ignition delay |  |
| open verstuiver | open nozzle |  |
| overbelasting | overload |  |
| overbrengas | transmission shaft |  |
| overstroomkIep | overflow valve |  |
| pakking | gasket |  |
| pakkingbus | stuffing box; packing box |  |
| papier filter | paper filter |  |
| persklep | charging valve; expansion valve |  |
| persklep | delivery valve |  |
| persklep met ontlastvolume (Atlas-klepje) | piston valve |  |
| petroleum (kerosine) | petroleum; kerosene (en-US) |  |
| pijpbekleding | pipe lagging |  |
| pilot injectie; -inspuiting | pilot injection |  |
| plaatklep | flap valve |  |
| plaatklep; schotelklep | disc valve |  |
...
| proefstand | test bed |  |
| radiateur; koeler | radiator |  |
| reductiekast | reduction gear |  |
| regelas; aandrijfas | driving shaft |  |
| regelklep | governor valve |  |
| regelmechanisme | control device |  |
| regelstang | actuating rod; control rod |  |
| regulateur | governor |  |
...
| regulateurkap | governor hood; governor cover |  |
| regulateurveer | governor spring |  |
| rem | brake |  |
| remvermogen | brake horse-power |  |
| rendement; nuttig effect | efficiency |  |
| ribbenkoeler | ribbed cooler |  |
| ringklep | annular valve; ring valve |  |
| ringsmering | ring lubrication |  |
| rollager | cylindrical roller bearing |  |
| rollager | roller bearing |  |
| rondsel | pinion |  |
| rookgrens | smoke point; smoke limit |  |
| rooster; roosterwerk | grating grill |  |
| roterende pomp | rotary pump |  |
| ruwe olie | crude oil |  |
| scharnier pijpen (voor zuigerkoeling) | swinging jointed pipes; swinging tubes |  |
| scharnierklep | hinged valve; flap valve |  |
...
| schoonmaak-opening | cleaning hole; cleaning door |  |
| schraapveer | oil scraper ring |  |
| schroefveer | helical spring |  |
| schuif | slide; slide valve |  |
| schuifafsluiter | gate valve; shut-off valve |  |
...
| smeeroliepomp; oliepomp | lubricating pump; oil pump |  |
| smeertoestel | lubricator oil box |  |
| snuifklep (voor krukkast) | snifting valve; crankcase breather |  |
...
| sproeier | nozzle |  |
| sproeier | jet |  |
| spuikraan | drain cock; outlet cock |  |
| starter; startmotor | starter |  |
| starterkrans | starter gear |  |
| startmotor | starting motor |  |
| startsproeier | starting jet |  |
| startverstuiver; startklep | starting injector; starting valve |  |
...
| stuwblok; druklager | thrust bearing |  |
| surge; pompage | surging |  |
...
| top-veer, bovenste | top ring; fire ring |  |
| tractie motor | traction motor; traction engine |  |
| trillingsdemper | vibration damper |  |
| trunkzuiger | trunk piston |  |
| tuimelaaras | rocker arm shaft; rocker arm pin |  |
| tuimelaarbus | rocker arm bush |  |
| tuit; mondstuk | nozzle |  |
| turbineschoep | turbine blade |  |
| turboblower; drukvulgroep | turbocharger |  |
| turboblower; drukvulgroep | turboblower |  |
| tussenas | countershaft |  |
| tussenas | intermediate shaft; countershaft; lay shaft |  |
| tweetakt cyclus | two-stroke cycle |  |
| uitlaat | exhaust; outlet |  |
...
| vaste koppeling | solid coupling; rigid coupling |  |
| vaste sproeier (onder vloeistofoppervlak) | submerged jet |  |
| vaste; stationaire installatie | fixed installation; stationary installation |  |
| vastlopen; vastzitten door lakvorming | sticking |  |
...
| ventilatie opening | air hole; air vent |  |
| ventilator; fan | air blower; ventilator; fan |  |
...
| versnellingshandel | gear lever (en-GB); gear shift (en-US) |  |
| verstuiver | injector |  |
| verstuivermondstuk | injector nozzle |  |
| verstuivernaald | injector needle |  |
| verticale motor | vertical engine |  |
| vetpot | lubricating box; grease box |  |
| vetpot; oliepot | grease cup; oil cup |  |
...
| vliegwiel | fly wheel |  |
| vliegwielnaaf | fly wheel hub; fly wheel boss |  |
| vliegwielstartinrichting | inertia starter |  |
| vlinderklep; smoorklep | butterfly valve |  |
| vlotter | float |  |
| vlotterkamer | carburettor float chamber |  |
| vlotterkraan; vlotterklep | float valve |  |
| vlotternaald | float needle valve of a carburettor |  |
| V-motor | V engine |  |
| volle belasting | full load |  |
| voorinspuiting | injection advance |  |
| voorkamer | pre-combustion chamber; combustion ante chamber |  |
| voorontsteking | ignition advance; spark advance |  |
| vreten | seizure |  |
...
| wrijvingskoppeling | friction type coupling; friction clutch |  |
| wrijvingskoppeling | friction clutch |  |
| zelfontbranding | spontaneous ignition; self-ignition |  |
| zijklep | side valve |  |
| zuiger | piston |  |
| zuiger mantel | piston skirt |  |
| zuiger motor | piston engine |  |
| zuigerkop; zuigerbodem | piston crown; piston head |  |
| zuigerlichaam | piston body |  |
| zuigerpen | gudgeon pin (en-GB); wristpin (en-US) |  |
...
| zuigerveer; brandveer zuigerveer | piston ring |  |
| zuigklep | suction valve |  |
| zuigleiding | air pipe |  |
| zuigventilator | suctionfan; exhauster |  |
